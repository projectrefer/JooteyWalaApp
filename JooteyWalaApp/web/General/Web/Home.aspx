<%@ Page Title="" Language="C#" MasterPageFile="~/web/General/Master/JooteyWala.master"
    AutoEventWireup="true" CodeFile="Home.aspx.cs" Inherits="web_General_Web_Home" %>
                                    ...
                                    <a href="single.html">
                                        <div class="view1 view-fifth1">
                                            <div class="top_box">
                                                ...
                                                <div class="grid_img">
                                                    <div class="css3">
                                                        <img src="../../images/pic11.jpg" alt="" /></div>
                                                    <div class="mask1">
                                                        <div class="info">
                                                            Quick View</div>
                                                    </div>
                            ...
                            <div class="box1">
                                <div class="col_1_of_single1 span_1_of_single1">
                                    <a href="single.html">
                                        ...
                                        <span class="rating1">
                                            <input type="radio" class="rating-input" id="Radio1" name="rating-input-1">
                                            <label for="rating-input-1-5" class="rating-star1">
                                            </label>
                                            <input type="radio" class="rating-input" id="Radio2" name="rating-input-1">
                                            <label for="rating-input-1-4" class="rating-star1">
                                            </label>
                                            <input type="radio" class="rating-input" id="Radio3" name="rating-input-1">
                                            <label for="rating-input-1-3" class="rating-star1">
                                            </label>
                                            <input type="radio" class="rating-input" id="Radio4" name="rating-input-1">
                                            <label for="rating-input-1-2" class="rating-star">
                                            </label>
                                            <input type="radio" class="rating-input" id="Radio5" name="rating-input-1">
                                            <label for="rating-input-1-1" class="rating-star">
                                            </label>
                                            &nbsp; (45) </span>
                                        <ul class="list2">
                                ...
                                <div class="col_1_of_single1 span_1_of_single1">
                                    <a href="single.html">
                                        ...
                                        <span class="rating1">
                                            <input type="radio" class="rating-input" id="Radio6" name="rating-input-1">
                                            <label for="rating-input-1-5" class="rating-star1">
                                            </label>
                                            <input type="radio" class="rating-input" id="Radio7" name="rating-input-1">
                                            <label for="rating-input-1-4" class="rating-star1">
                                            </label>
                                            <input type="radio" class="rating-input" id="Radio8" name="rating-input-1">
                                            <label for="rating-input-1-3" class="rating-star1">
                                            </label>
                                            <input type="radio" class="rating-input" id="Radio9" name="rating-input-1">
                                            <label for="rating-input-1-2" class="rating-star">
                                            </label>
                                            <input type="radio" class="rating-input" id="Radio10" name="rating-input-1">
                                            <label for="rating-input-1-1" class="rating-star">
                                            </label>
                                            &nbsp; (45) </span>
                                        <ul class="list2">
                                    ...
                                    <a href="single.html">
                                        <div class="view1 view-fifth1">
                                            <div class="top_box">
                                                ...
                                                <div class="grid_img">
                                                    <div class="css3">
                                                        <img src="../../images/pic9.jpg" alt="" /></div>
                                                    <div class="mask1">
                                                        <div class="info">
                                                            Quick View</div>
                                                    </div>
                                        ...
                                        <span class="rating1">
                                            <input type="radio" class="rating-input" id="Radio11" name="rating-input-1">
                                            <label for="rating-input-1-5" class="rating-star1">
                                            </label>
                                            <input type="radio" class="rating-input" id="Radio12" name="rating-input-1">
                                            <label for="rating-input-1-4" class="rating-star1">
                                            </label>
                                            <input type="radio" class="rating-input" id="Radio13" name="rating-input-1">
                                            <label for="rating-input-1-3" class="rating-star1">
                                            </label>
                                            <input type="radio" class="rating-input" id="Radio14" name="rating-input-1">
                                            <label for="rating-input-1-2" class="rating-star">
                                            </label>
                                            <input type="radio" class="rating-input" id="Radio15" name="rating-input-1">
                                            <label for="rating-input-1-1" class="rating-star">
                                            </label>
                                            &nbsp; (45) </span>
                                        <ul class="list2">
